...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/circuit_part_g_j2.pdf}
    \caption{Quantum circuits for all configurations}
...
\Cref{alg:vqe} gives a self-contained description of the VQE procedure as implemented in this project. All source code is available in the project repository \parencite{fys5419-repo, claudoverius-repo}.
{\small
\begin{algorithm}[H]
