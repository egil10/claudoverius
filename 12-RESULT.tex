...
With this we find a maximum error of $2.92\times10^{-11}$ and $1.80\times10^{-2}$ for $J=1$ ($N=2$) and $J=2$ ($N=4$) respectively, with mean errors of $\approx10^{-12}$ and $\approx10^{-3}$.
